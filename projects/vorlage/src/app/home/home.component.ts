...
export class HomeComponent {
  ...
  ShowConfirm() {
    ...
    this.dialogService.YesNoDialog('Bavaria denn zünftig sammawiedaguad nia, mechad. Um Godds wujn Wurscht- solod aasgem oamoi Enzian, Woibbadinga schnacksln ebba ?').subscribe(antwort => { alert(antwort) })
